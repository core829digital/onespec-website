      ...
      <div className="relative">
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-white">Analisi configuratore</h3>
          </div>
        ...
        <div className="mb-4 grid grid-cols-2 gap-3">
          <div className="rounded-lg bg-white/5 p-3">
            <p className="text-[11px] font-medium text-white/50">Visite widget</p>
            <p className="text-lg font-semibold text-white">24,5K</p>
            <span className="text-[11px] font-medium text-[var(--color-mint)]">+12,3%</span>
          </div>

          <div className="rounded-lg bg-white/5 p-3">
            <p className="text-[11px] font-medium text-white/50">Preventivi</p>
        ...
        <div className="flex items-center justify-between">
          <span className="text-[11px] font-medium text-white/50">Ultimi 7 giorni</span>
          <button
            type="button"
